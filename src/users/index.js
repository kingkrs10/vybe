...
router.get("/recentUsers", authMiddleware, usersController.getRecentUsers);
router.get("/:emailAddress", authMiddleware, usersController.getOne);
router.delete("/:id", authMiddleware, usersController.remove);
router.put("/location/:id", authMiddleware, usersController.updateLocation);
router.put(
  "/blockedUsers/:id",
  authMiddleware,
...
router.get("/getAuthToken/:emailAddress", usersController.getAuthToken);
router.put(
  "/updateStripeId/:id",
  authMiddleware,
