...
router.post("/sendSMS", authMiddleware, controller.sendSMS);

router.post("/sendMail", authMiddleware, controller.sendMail);

router.post("/migration", authMiddleware, controller.migration);
...
router.post("/offerMigration", authMiddleware, controller.offerMigration);
